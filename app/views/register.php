...
<div class="flex h-screen">
    ...
    <div class="flex-1 lg:ml-64 flex items-center justify-center bg-gray-50 p-4">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
            <h1 class="text-4xl font-camagru text-center text-blue-600 mb-2">CAMAGRU</h1>
            ...
            <form action="/user/registerSubmit" method="POST" class="space-y-4">
                ...
                <button type="submit" class="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition duration-200 font-medium">S'inscrire</button>
            </form>
            <p class="text-sm text-center text-gray-600 mt-6">Déjà inscrit ? <a href="/user/login" class="text-blue-600 hover:underline font-medium">Connexion</a></p>
        </div>
    </div>
</div>
